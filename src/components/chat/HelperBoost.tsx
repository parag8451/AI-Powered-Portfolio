    ...
    <>
      <Drawer.Root open={open} onOpenChange={setOpen}>
            ...
            <div className="w-full">
              ...
              >
                ...
                <Button
                  ...
                  variant="outline"
                  className="border border-neutral-200/60 dark:border-neutral-700/60 hover:bg-neutral-50 dark:hover:bg-neutral-800 h-auto min-w-[100px] flex-shrink-0 cursor-pointer rounded-xl bg-white/60 dark:bg-neutral-800/60 px-4 py-3 shadow-none backdrop-blur-md transition-all duration-300 active:scale-95 hover:shadow-sm hover:border-neutral-300 dark:hover:border-neutral-600"
                >
                ...
                <TooltipProvider>
                  <Tooltip delayDuration={0}>
                    <TooltipTrigger asChild>
                      ...
                      <motion.div
                        className="hover:bg-neutral-50 dark:hover:bg-neutral-800 flex h-auto cursor-pointer items-center space-x-1 rounded-xl border border-neutral-200/60 dark:border-neutral-700/60 bg-white/60 dark:bg-neutral-800/60 px-4 py-3 text-sm backdrop-blur-md transition-all duration-300 hover:shadow-sm"
                        whileHover={{ scale: 1 }}
                        whileTap={{ scale: 0.98 }}
                      >
                        <div className="flex items-center gap-3 text-gray-900 dark:text-gray-100">
        ...
        <Drawer.Portal>
          ...
          <Drawer.Content className="fixed right-0 bottom-0 left-0 z-100 mt-24 flex h-[80%] flex-col rounded-t-2xl border-t border-neutral-200/50 bg-background shadow-2xl outline-none dark:border-neutral-700/50 lg:h-[60%]">
            <div className="flex-1 overflow-y-auto rounded-t-2xl bg-card p-4">
