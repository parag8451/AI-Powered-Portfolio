...
const InternshipCard = () => {
  const openMail = () => {
    window.open('mailto:paraganabhavane18@gmail.com', '_blank');
  };
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-blue-50/30 via-purple-50/30 to-pink-50/30 dark:from-blue-950/20 dark:via-purple-950/20 dark:to-pink-950/20 mx-auto mt-8 w-full max-w-4xl rounded-3xl px-6 py-8 font-sans sm:px-10 md:px-16 md:py-12 backdrop-blur-xl border border-white/10 shadow-cinematic"
    >
      {/* Header */}
      ...
      <div className="mt-10 flex justify-center">
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="cursor-pointer rounded-full bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-3 font-bold text-white transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/50"
        >
          Contact me →
        </motion.button>
      </div>
