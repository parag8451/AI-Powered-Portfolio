...
export function Resume() {
  // Resume details
  const resumeDetails = {
    title: "Parag's Resume",
    description: 'Electronics & Telecommunication | AI & GenAI',
    fileType: 'PDF',
    lastUpdated: 'March 2026',
    fileSize: '69 KB',
    previewImageSrc: '/PARAG-Res.png',
    downloadUrl: '/PARAG-Res.pdf',
  };
      ...
      >
        ...
        <div className="p-5">
          <div className="flex items-center justify-between">
            ...
            {/* Download indicator */}
            <motion.div
              className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-sm transition-shadow duration-300 group-hover:shadow-lg group-hover:shadow-purple-500/30"
              initial={{ scale: 1 }}
