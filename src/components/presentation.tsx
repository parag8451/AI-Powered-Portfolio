...
export function Presentation() {
  ...
  const profile = {
    ...
    age: 'Electronics & Telecommunication student',
    location: 'Mumbai, India',
    // Add a newline character after the emoji
    description:
      "Hey 👋\nI'm Parag, building AI-powered experiences that talk back, think with you, and make static tech feel alive.",
          ...
          >
            {['AI', 'Developer', 'Sport', 'SaaS Builder'].map(
              (tag) => (
                <span
                  key={tag}
                  className="rounded-full border border-purple-200/50 bg-purple-50/50 px-3 py-1 text-sm font-medium text-purple-700 dark:border-purple-500/20 dark:bg-purple-500/10 dark:text-purple-300"
                >
                  {tag}
                </span>
              )
