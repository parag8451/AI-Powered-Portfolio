...
const githubButtonVariants = cva(
  'cursor-pointer relative overflow-hidden will-change-transform backface-visibility-hidden transform-gpu transition-all duration-300 ease-out hover:scale-105 group whitespace-nowrap focus-visible:outline-hidden inline-flex items-center justify-center whitespace-nowrap font-medium ring-offset-background disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0 hover:shadow-lg',
  {
    variants: {
      variant: {
        default:
          'bg-gradient-to-r from-neutral-900 to-neutral-800 hover:from-neutral-800 hover:to-neutral-700 text-white border-gray-700 dark:from-neutral-50 dark:to-neutral-100 dark:border-gray-300 dark:text-zinc-950 dark:hover:from-white dark:hover:to-neutral-50 hover:shadow-purple-500/20 backdrop-blur-sm',
        outline:
          'bg-background/50 text-accent-foreground border border-input hover:bg-accent backdrop-blur-sm hover:border-purple-400/50 dark:hover:border-purple-500/50',
      },
      size: {
        default:
          'h-8.5 rounded-full px-3 gap-2 text-[0.8125rem] leading-none [&_svg]:size-4 gap-2',
        sm: 'h-7 rounded-full px-2.5 gap-1.5 text-xs leading-none [&_svg]:size-3.5 gap-1.5',
        lg: 'h-10 rounded-full px-4 gap-2.5 text-sm leading-none [&_svg]:size-5 gap-2.5',
      },
    },
    defaultVariants: {
      variant: 'default',
