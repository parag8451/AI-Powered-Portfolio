...
const chatBubbleMessageVariants = cva("", {
  variants: {
    variant: {
      ...
      sent: "p-2 px-5 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-3xl shadow-lg hover:shadow-xl hover:shadow-purple-500/30 transition-all duration-300",
    },
    layout: {
      default: "",
      ai: "border-t border-purple-200/30 dark:border-purple-500/10 w-full rounded-none bg-transparent",
    },
  },
  defaultVariants: {
    variant: "received",
